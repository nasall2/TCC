...
\item{The field \textit{transport\_stream\_ID} has 16 bits, the first most significant two shall be '00' and the other 10 bits are the length of the section, starting at the first bit after the length field and including the CRC;}
\item{The field \textit{version\_number} has 5 bits,
\item{The field \textit{current\_next\_indicator} has 1 bit,
\item{The field \textit{section\_number} has 8 bits,
\item{The field \textit{last\_section\_number} has 8 bits,

\item{.}
\end{itemize}

A field at the beginning of the table ()  and section number field serves as a counter if the table is divided into several sections.
...
\includegraphics[width=1\linewidth]{figuras/tab_psi_tables_names_pids.png}
