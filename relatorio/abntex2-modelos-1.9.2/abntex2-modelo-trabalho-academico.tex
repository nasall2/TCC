...
Historicamente, a televisão está presente nas casas dos cidadãos brasileiros e é a principal fonte de
entretenimento e informação para a população. Nos últimos 10 anos, os novos meios de comunicação digital, tais
como o computador e o telefone celular, estão sendo assimilados pela população de diferentes classes sociais. Um
dado recente afirma que já 46% da população brasileira dispõe de uma linha de telefone celular. Embora seja 
significativa, a participação deste meio ainda é muito inferior à da televisão, cuja área de cobertura de sinal atinge
100% da população por via satelital, e próximo de 70% da população por via terrestre. A televisão é, portanto, o
principal canal de comunicação disponível ao grande público no Brasil.

Ainda que tenha cobertura incomparável às demais tecnologias, a televisão é, a grosso modo, um meio de comunicação
unidirecional. Não há possibilidade, no atual sistema de transmissão adotado no Brasil, de haver interatividade dos
...
retornar dados para a geradora. Ao usuário podem ser apresentadas opções de programação e, a partir de sua escolha,
a geradora envia o conteúdo. Assim, se poderia aliar a interatividade da \textit{Internet} à abrangência
da televisão e com isso promover a inclusão social de regiões remotas, sem acesso à infraestrutura de dados em alta
velocidade presente nas grandes metrópoles.

Essa tecnologia é inviável com a infraestrutura atual da televisão analógica: é impossível enviar através de um único
canal analógico mais de um conteúdo de vídeo ou áudio simultaneamente. Como solução a essa dificuldade, desenvolveu-se
o sistema de transmissão digital descrito pela norma ISO/IEC 13818, comercialmente conhecido pela sigla que dá nome ao
comitê formado para redigí-la, o MPEG2. A norma descreve um padrão de transmissão e codificação de vídeo, áudio e dados
digitais que permite, entre outras funções, transmitir conteúdos audiovisuais independentes simultaneamente, permitindo
...
avaliações, foi concluído que o sistema com melhor performance no território brasileiro seria baseado no ISDB, japonês,
com modificações.

As diferenças entre o padrão ISDB original e o adotado no Brasil referem-se principalmente à codificação de vídeo e à
plataforma de interatividade. Com o intuito de promover a indústria nacional, o governo determinou a adoção de uma
plataforma de código aberto, desenvolvida nacionalmente pela PUC-RJ, o Ginga. Tal ferramenta é acessível a quem quer
que esteja interessado em desenvolver uma interface interativa, contanto que disponha de um ambiente de desenvolvimento
apropriado. A similaridade do sistema de transmissão brasileiro com o padrão internacional MPEG2 e a não
obrigatoriedade da transmissão de interfaces interativas levou ao abandono do desenvolvimento de tecnologia nacional,
de modo que atualmente muito pouco se investe para a criação de equipamentos para a televisão digital em terrítório
brasileiro.
 ...
 vídeo, áudio e dados no fluxo de transmissão. Não é possível, como na televisão analógica, transmitir simultaneamente
 som e imagem. É preciso dividir os sinais e enviá-los independentemente, para depois recombiná-los para apresentar
 ao usuário.
...
Aqui pode ser descrito o Transport Stream do MPEG2, com suas tabelas PSI e PES.
