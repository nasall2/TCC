...
As a solution to this difficulty , we developed the digital transmission system described by ISO / IEC 13818 standard, commercially known by the acronym which names the committee formed to draft it , MPEG2 . The standard describes a standard encoding and transmitting video , audio and data and allows , among other functions , independent transmit audiovisual content simultaneously , thus allowing the system user selection from among the information sent by the generator , which he wants to receive.

Since 1994 , private companies and government funded research and technical tests to compare the performance of three digital television systems at that time were known to be efficient in their countries of origin : ATSC , developed in the United States ; DVB , developed by European countries ; and ISDB , developed in Japan All three systems have differences regarding the encoding of video and audio , but the DVB and ISDB , for example , share the transportation infrastructure data MPEG2 standard , but differ in the modulation schemes signal. After the evaluations , it was determined that the system with the best performance likely in Brazilian territory would be based on ISDB , Japanese , with modifications .

The differences between the original and the ISDB standard used in Brazil mainly relate to video encoding and interactivity platform. In order to promote the development of national industry , the government decided to adopt a platform interactivity open source , developed mainly with the PUC - RJ technology , Ginga . Through this tool, you can , for example , take information utility to the low-income population without access
the \ textit { Internet } , as demonstrated by the CEF in 2010 \ cite { box } . However , the similarity of the Brazilian transmission system with the international standard MPEG2 and not mandating the use of interactive interfaces 2015 led to the disinterest of the generators in the development of technology ,
so that currently very little is invested in the creation of interactive digital television for equipment in Brazilian territory .
