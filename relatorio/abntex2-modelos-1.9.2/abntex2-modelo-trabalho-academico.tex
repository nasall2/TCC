...
plataforma de código aberto, desenvolvida nacionalmente pela PUC-RJ, o Ginga. Tal ferramenta é acessível a quem
estvier interessado em desenvolver uma interface interativa, contanto que disponha de um ambiente de desenvolvimento
apropriado. A similaridade do sistema de transmissão brasileiro com o padrão internacional MPEG2 e a não
obrigatoriedade da utilização de interfaces interativas levou ao desinteresse no desenvolvimento de tecnologia nacional,
...
e os canais de radiofrequência devolvidos á união... COLOCAR REFERENCIA! 
