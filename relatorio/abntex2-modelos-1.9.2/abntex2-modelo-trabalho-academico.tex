...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \assinatura{\textbf{\imprimirorientador} \\ Orientador e Coordenador}
   \assinatura{\textbf{Eng. Rhadam Igor Elias de Miranda} \\ Convidado RBS TV}
   \assinatura{\textbf{Prof. PhD. Sergio Bampi} \\ Convidado UFRGS}
