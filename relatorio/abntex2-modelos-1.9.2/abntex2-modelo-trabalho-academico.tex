...
Figure \ref{fig:TSAnalyser_close_PMT}, that follows, shows a snapshot of the analyser output for a PMT table. program number, table ID, PCR_PID, stream types e PIDs, descriptors.
